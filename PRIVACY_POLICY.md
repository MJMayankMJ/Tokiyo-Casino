# Tokiyo Cards — Privacy Policy

**Effective date:** 2026-05-29
**App:** Tokiyo Cards (iOS)
**Bundle ID:** com.mayank.Tokiyo-Casino
**Contact:** pawan99tiwari@gmail.com

This policy describes what Tokiyo Cards does and does not do with your data.

## At a glance

- **No account or login is required.**
- **No real-money gambling, no in-app purchases, no withdrawals, no redemptions, and no cash value.** All chips in the app are virtual and used only inside the app for entertainment.
...
Tokiyo Cards does **not** collect, transmit, or store personal information on any server we control. We have no developer-side database, no analytics pipeline, and no advertising integrations.
...
| --- | --- | --- |
| Virtual chip balance | Core Data | Gameplay state |
| Sound mute preference, reconnect metadata, last display name | UserDefaults | Remembers app-only settings |
| First-launch chip-grant flag | UserDefaults | Ensures the one-time 1000-chip welcome grant is given exactly once |
...
- gameplay events (cards dealt to you, community cards, raise/fold actions, round results),
...
Because nothing is sent to our servers, deleting the app removes everything stored locally. There is no account to delete on our side because there are no accounts.

## Children

Tokiyo Cards is suitable for general audiences. The app contains simulated card-game gameplay (Texas Hold'em poker, Jackaroo). Parents who want to restrict access can use iOS's built-in Screen Time and content restrictions.
